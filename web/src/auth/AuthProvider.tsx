...
import { splicepalClient, weldpalClient, poolpalClient, voltpalClient, pipepalClient, type AppKey } from '../lib/supabase'
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ splicepal, weldpal, poolpal, voltpal, pipepal, signIn, signInWithMagicLink, signOut }}>
      {children}
