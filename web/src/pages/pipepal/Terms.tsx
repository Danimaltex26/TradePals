...
export default function PipePalTerms() {
  return (
    <LegalPage title="PipePal Terms of Service">
      ...
      <p>
        ...
        company located in Bexar County, Texas. They govern your use of the PipePal mobile application
        and the PipePal sections of tradepals.net (together, the "Service"). By creating an account or
        using PipePal you agree to these Terms. If you do not agree, do not use the Service.
      </p>

      <h2 className="text-xl font-bold text-white mt-6">1. Eligibility</h2>
      <p>
        You must be at least 18 years old (or the age of majority in your jurisdiction) to use PipePal.
      ...
      <p>
        PipePal offers paid subscriptions purchased through Apple's App Store. The following terms apply
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li>You can manage and cancel subscriptions in your Apple ID account settings (Settings → your name → Subscriptions → PipePal). Cancellation takes effect at the end of the current billing period.</li>
      ...
      <p>
        PipePal uses AI to analyze plumbing photos, suggest fixes, and provide code reference information
        (IPC/UPC). <strong>AI output is provided for informational purposes only and is not a
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li>PipePal analyzes <strong>photos and descriptions only</strong>. It is <strong>NOT</strong> a substitute for proper pressure testing, leak testing, or the judgment of a licensed plumber, master plumber, or plumbing inspector.</li>
        <li>AI analysis can be incomplete, inaccurate, or wrong. You are solely responsible for verifying any AI-suggested diagnosis against actual field conditions, equipment manufacturer specifications, applicable codes (IPC, UPC, local amendments), and your jurisdiction's requirements.</li>
        <li>You must not rely on PipePal as the sole basis for pipe repairs, gas line work, fixture installation, or any action affecting life safety or building code compliance.</li>
        <li>Exam prep content is intended as study material only and does not guarantee passing any exam or qualify you for any license (journeyman, master, or otherwise).</li>
      </ul>

      <h2 className="text-xl font-bold text-white mt-6">6. Intellectual property</h2>
      <p>
        TradePals owns the PipePal application, its content (other than user-submitted content), trademarks,
      ...
      <p>
        You retain ownership of content you upload (such as plumbing photos). By uploading content, you
      ...
      <p>
        ...
        DAMAGES, OR FOR ANY LOST PROFITS, LOST DATA, BUSINESS INTERRUPTION, WATER DAMAGE, PLUMBING
      ...
      <p>
        If you downloaded PipePal from Apple's App Store, you acknowledge that these Terms are between
        you and TradePals only, not Apple, and that Apple has no obligation to provide maintenance or
        support for PipePal. Apple is a third-party beneficiary of these Terms and may enforce them
