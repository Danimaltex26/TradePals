...
export default function PipePalPrivacy() {
  return (
    <LegalPage title="PipePal Privacy Policy">
      <p><strong>Effective date:</strong> {EFFECTIVE_DATE}</p>
      <p>
        This Privacy Policy describes how TradePals, LLC ("TradePals," "we," "our," or "us") collects, uses,
        and shares information when you use the PipePal mobile app and the PipePal sections of
        tradepals.net (collectively, the "Service"). By using PipePal, you agree to the practices described
        below.
      </p>

      <h2 className="text-xl font-bold text-white mt-6">1. Who we are</h2>
      <p>
        PipePal is operated by <strong>TradePals, LLC</strong>, a Texas limited liability company located
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li><strong>Content you submit</strong> — plumbing photos, leak images, pipe installation photos and other images you upload for AI analysis, troubleshooting forms you fill out, code reference lookups, exam prep activity, and any notes you save.</li>
        <li><strong>Usage data</strong> — pipe analyses, troubleshooting sessions, code lookups, features you use, and timestamps. We use this to provide history, save your work, and enforce subscription limits.</li>
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li>To provide AI-powered plumbing photo analysis and troubleshooting features.</li>
      ...
      <p>We share information only with service providers that help us operate PipePal:</p>
      <ul className="list-disc pl-6 space-y-1">
        <li><strong>Anthropic (Claude API)</strong> — image and text content you submit for plumbing analysis is sent to Anthropic solely to generate the AI response. Anthropic processes this content under their own terms; per their published API policy, content sent through the API is not used to train their models.</li>
      ...
      <p>
        PipePal is operated from the United States. By using the Service, you understand that your
      ...
      <p>
        PipePal is not directed to children under 13 (or under 16 in the EEA), and we do not knowingly
      ...
      <p className="mt-6 text-sm text-gray-400 italic">
        PipePal analyzes plumbing photos and provides reference information only. It is not a substitute for proper leak testing, pressure testing, or the judgment of a licensed plumber or plumbing inspector.
      </p>
    </LegalPage>
  )
}
