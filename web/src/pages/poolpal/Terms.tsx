...
export default function PoolPalTerms() {
  return (
    <LegalPage title="PoolPal Terms of Service">
      ...
      <p>
        ...
        company located in Bexar County, Texas. They govern your use of the PoolPal mobile application
        and the PoolPal sections of tradepals.net (together, the "Service"). By creating an account or
        using PoolPal you agree to these Terms. If you do not agree, do not use the Service.
      </p>

      <h2 className="text-xl font-bold text-white mt-6">1. Eligibility</h2>
      <p>
        You must be at least 18 years old (or the age of majority in your jurisdiction) to use PoolPal.
      ...
      <p>
        PoolPal offers paid subscriptions purchased through Apple's App Store. The following terms apply
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li>You can manage and cancel subscriptions in your Apple ID account settings (Settings → your name → Subscriptions → PoolPal). Cancellation takes effect at the end of the current billing period.</li>
      ...
      <p>
        PoolPal uses AI to analyze pool/spa photos, suggest troubleshooting steps, and provide reference
        information. <strong>AI output is provided for informational purposes only and is not a substitute
        for professional judgment.</strong>
      </p>
      <p>
        Specifically, you understand and agree that:
      </p>
      <ul className="list-disc pl-6 space-y-1">
        <li>PoolPal analyzes <strong>visual conditions only</strong>. It is <strong>NOT</strong> a substitute for professional water testing equipment (Taylor K-2005/K-2006, FAS-DPD test kits), nor for the judgment of a licensed pool contractor, Certified Pool Operator (CPO), or health inspector.</li>
        <li>AI analysis can be incomplete, inaccurate, or wrong. You are solely responsible for verifying any AI-suggested diagnosis against actual water test results, equipment manufacturer specifications, applicable codes (APSP/ICC, NSF/ANSI 50, state/county health codes), and your contract's requirements.</li>
        <li>You must not rely on PoolPal as the sole basis for chemical treatment decisions, equipment replacement, or any action affecting public health or safety.</li>
        <li>Certification prep content is intended as study material only and does not guarantee passing any certification exam or qualify you for any certification (CPO, AFO, PHTA CST, CPI, or otherwise).</li>
      </ul>

      <h2 className="text-xl font-bold text-white mt-6">6. Intellectual property</h2>
      <p>
        TradePals owns the PoolPal application, its content (other than user-submitted content), trademarks,
      ...
      <p>
        You retain ownership of content you upload (such as pool photos). By uploading content, you
      ...
      <p>
        ...
        DAMAGES, OR FOR ANY LOST PROFITS, LOST DATA, BUSINESS INTERRUPTION, EQUIPMENT DAMAGE, WATER
        CHEMISTRY ISSUES, OR OTHER LOSSES ARISING OUT OF OR RELATED TO YOUR USE OF OR INABILITY TO USE
      ...
      <p>
        If you downloaded PoolPal from Apple's App Store, you acknowledge that these Terms are between
        you and TradePals only, not Apple, and that Apple has no obligation to provide maintenance or
        support for PoolPal. Apple is a third-party beneficiary of these Terms and may enforce them
