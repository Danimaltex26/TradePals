...
export default function PoolPalPrivacy() {
  return (
    <LegalPage title="PoolPal Privacy Policy">
      <p><strong>Effective date:</strong> {EFFECTIVE_DATE}</p>
      <p>
        This Privacy Policy describes how TradePals, LLC ("TradePals," "we," "our," or "us") collects, uses,
        and shares information when you use the PoolPal mobile app and the PoolPal sections of
        tradepals.net (collectively, the "Service"). By using PoolPal, you agree to the practices described
        below.
      </p>

      <h2 className="text-xl font-bold text-white mt-6">1. Who we are</h2>
      <p>
        PoolPal is operated by <strong>TradePals, LLC</strong>, a Texas limited liability company located
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li><strong>Account information</strong> — email address, password (hashed), display name, and any optional profile fields you provide (such as service specialties, certifications, primary industry, and experience level).</li>
        <li><strong>Content you submit</strong> — pool/spa photos, water chemistry images, equipment photos and other images you upload for AI analysis, troubleshooting forms you fill out, reference lookups, certification quiz activity, and any notes you save.</li>
        <li><strong>Usage data</strong> — pool analyses, troubleshooting sessions, reference lookups, features you use, and timestamps. We use this to provide history, save your work, and enforce subscription limits.</li>
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li>To provide AI-powered pool and equipment analysis and troubleshooting features.</li>
      ...
      <p>We share information only with service providers that help us operate PoolPal:</p>
      <ul className="list-disc pl-6 space-y-1">
        <li><strong>Anthropic (Claude API)</strong> — image and text content you submit for pool and equipment analysis is sent to Anthropic solely to generate the AI response. Anthropic processes this content under their own terms; per their published API policy, content sent through the API is not used to train their models.</li>
      ...
      <p>
        PoolPal is operated from the United States. By using the Service, you understand that your
      ...
      <p>
        PoolPal is not directed to children under 13 (or under 16 in the EEA), and we do not knowingly
      ...
      <p className="mt-6 text-sm text-gray-400 italic">
        PoolPal analyzes visual conditions only. It is not a substitute for professional water testing with a certified test kit, nor for the judgment of a licensed pool contractor or health inspector.
      </p>
    </LegalPage>
  )
}
