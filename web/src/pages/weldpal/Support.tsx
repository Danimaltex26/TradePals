...
export default function WeldPalSupport() {
  return (
    <LegalPage title="WeldPal Support">
      <p>
        Need help with WeldPal? We're here to assist.
      </p>
      ...
      <p><strong>How do I cancel my subscription?</strong> Subscriptions are managed through your Apple ID. On iOS, open Settings → your name → Subscriptions → WeldPal.</p>
      ...
      <p><strong>Does WeldPal replace NDT?</strong> No. WeldPal analyzes visual surface defects only. Always follow your project's NDT requirements and code.</p>
    </LegalPage>
  )
}
