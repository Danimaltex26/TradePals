  ...
  return (
    <LegalPage title="WeldPal Privacy Policy">
      ...
      <p>
        ...
        and shares information when you use the WeldPal mobile app and the WeldPal sections of
        tradepals.net (collectively, the "Service"). By using WeldPal, you agree to the practices described
        below.
      </p>

      <h2 className="text-xl font-bold text-white mt-6">1. Who we are</h2>
      <p>
        WeldPal is operated by <strong>TradePals, LLC</strong>, a Texas limited liability company located
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li><strong>Account information</strong> — email address, password (hashed), display name, and any optional profile fields you provide (such as welding processes, certifications, primary industry, and experience level).</li>
        <li><strong>Content you submit</strong> — weld photos and other images you upload for AI analysis, troubleshooting forms you fill out, reference lookups, certification quiz activity, and any notes you save.</li>
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li>To provide AI-powered weld defect analysis and troubleshooting features.</li>
      ...
      <p>We share information only with service providers that help us operate WeldPal:</p>
      <ul className="list-disc pl-6 space-y-1">
      ...
      <p>
        WeldPal is operated from the United States. By using the Service, you understand that your
      ...
      <p>
        WeldPal is not directed to children under 13 (or under 16 in the EEA), and we do not knowingly
