...
export default function VoltPalTerms() {
  return (
    <LegalPage title="VoltPal Terms of Service">
      ...
      <p>
        ...
        company located in Bexar County, Texas. They govern your use of the VoltPal mobile application
        and the VoltPal sections of tradepals.net (together, the "Service"). By creating an account or
        using VoltPal you agree to these Terms. If you do not agree, do not use the Service.
      </p>

      <h2 className="text-xl font-bold text-white mt-6">1. Eligibility</h2>
      <p>
        You must be at least 18 years old (or the age of majority in your jurisdiction) to use VoltPal.
      ...
      <p>
        VoltPal offers paid subscriptions purchased through Apple's App Store. The following terms apply
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li>You can manage and cancel subscriptions in your Apple ID account settings (Settings → your name → Subscriptions → VoltPal). Cancellation takes effect at the end of the current billing period.</li>
      ...
      <p>
        VoltPal uses AI to analyze electrical photos, suggest troubleshooting steps, and provide NEC
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li>VoltPal analyzes <strong>photos and descriptions only</strong>. It is <strong>NOT</strong> a substitute for proper testing with calibrated meters (multimeter, megger, clamp meter), nor for the judgment of a licensed electrician, master electrician, or electrical inspector.</li>
        ...
        <li>You must not rely on VoltPal as the sole basis for energized work decisions, circuit modifications, equipment replacement, or any action affecting life safety.</li>
      ...
      <p>
        TradePals owns the VoltPal application, its content (other than user-submitted content), trademarks,
      ...
      <p>
        You retain ownership of content you upload (such as electrical photos). By uploading content, you
      ...
      <p>
        If you downloaded VoltPal from Apple's App Store, you acknowledge that these Terms are between
        you and TradePals only, not Apple, and that Apple has no obligation to provide maintenance or
        support for VoltPal. Apple is a third-party beneficiary of these Terms and may enforce them
