...
export default function VoltPalPrivacy() {
  return (
    <LegalPage title="VoltPal Privacy Policy">
      <p><strong>Effective date:</strong> {EFFECTIVE_DATE}</p>
      <p>
        This Privacy Policy describes how TradePals, LLC ("TradePals," "we," "our," or "us") collects, uses,
        and shares information when you use the VoltPal mobile app and the VoltPal sections of
        tradepals.net (collectively, the "Service"). By using VoltPal, you agree to the practices described
        below.
      </p>

      <h2 className="text-xl font-bold text-white mt-6">1. Who we are</h2>
      <p>
        VoltPal is operated by <strong>TradePals, LLC</strong>, a Texas limited liability company located
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li><strong>Content you submit</strong> — electrical panel photos, fault images, equipment photos and other images you upload for AI analysis, troubleshooting forms you fill out, NEC reference lookups, exam prep activity, and any notes you save.</li>
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li>To provide AI-powered electrical photo analysis and troubleshooting features.</li>
      ...
      <p>We share information only with service providers that help us operate VoltPal:</p>
      <ul className="list-disc pl-6 space-y-1">
        <li><strong>Anthropic (Claude API)</strong> — image and text content you submit for electrical analysis is sent to Anthropic solely to generate the AI response. Anthropic processes this content under their own terms; per their published API policy, content sent through the API is not used to train their models.</li>
      ...
      <p>
        VoltPal is operated from the United States. By using the Service, you understand that your
      ...
      <p>
        VoltPal is not directed to children under 13 (or under 16 in the EEA), and we do not knowingly
      ...
      <p className="mt-6 text-sm text-gray-400 italic">
        VoltPal analyzes electrical photos and provides reference information only. It is not a substitute for proper testing with calibrated meters, nor for the judgment of a licensed electrician or electrical inspector.
      </p>
    </LegalPage>
  )
}
