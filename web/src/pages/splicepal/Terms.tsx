...
export default function SplicePalTerms() {
  return (
    <LegalPage title="SplicePal Terms of Service">
      ...
      <p>
        ...
        company located in Bexar County, Texas. They govern your use of the SplicePal mobile application
        and the SplicePal sections of tradepals.net (together, the "Service"). By creating an account or
        using SplicePal you agree to these Terms. If you do not agree, do not use the Service.
      </p>

      <h2 className="text-xl font-bold text-white mt-6">1. Eligibility</h2>
      <p>
        You must be at least 18 years old (or the age of majority in your jurisdiction) to use SplicePal.
      ...
      <p>
        SplicePal offers paid subscriptions purchased through Apple's App Store. The following terms apply
      ...
      <ul className="list-disc pl-6 space-y-1">
        ...
        <li>You can manage and cancel subscriptions in your Apple ID account settings (Settings → your name → Subscriptions → SplicePal). Cancellation takes effect at the end of the current billing period.</li>
      ...
      <p>
        SplicePal uses third-party artificial intelligence (Anthropic Claude) to analyze OTDR traces,
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li>SplicePal is a productivity and reference tool for trained fiber-optic technicians. It is <strong>not</strong> a certified test instrument and does not replace OTDR equipment, optical loss test sets, or other certified measurement tools.</li>
        <li>AI analysis can be incomplete, inaccurate, or wrong. You are solely responsible for verifying any AI-suggested diagnosis, splice loss interpretation, or remediation step against the actual physical fiber, the OTDR equipment manufacturer's specifications, applicable industry standards (such as TIA-568, IEC 61280), and your project's acceptance criteria.</li>
        <li>Certification prep content is intended as study material only and does not guarantee passing any certification exam or qualify you for any certification (CFOT, CFOS, BFT, FOT, or otherwise).</li>
        <li>You must not rely on SplicePal as the sole basis for any safety-critical decision, contractual deliverable, or work that requires sign-off by a qualified inspector or engineer.</li>
      </ul>

      <h2 className="text-xl font-bold text-white mt-6">6. Intellectual property</h2>
      <p>
        TradePals owns the SplicePal application, its content (other than user-submitted content), trademarks,
      ...
      <p>
        You retain ownership of content you upload (such as OTDR trace images). By uploading content, you
      ...
      <p>
        ...
        DAMAGES, OR FOR ANY LOST PROFITS, LOST DATA, BUSINESS INTERRUPTION, OR FAILED FIBER LINK
        REMEDIATION, ARISING OUT OF OR RELATED TO YOUR USE OF OR INABILITY TO USE THE SERVICE, EVEN IF
      ...
      <p>
        If you downloaded SplicePal from Apple's App Store, you acknowledge that these Terms are between
        you and TradePals only, not Apple, and that Apple has no obligation to provide maintenance or
        support for SplicePal. Apple is a third-party beneficiary of these Terms and may enforce them
