...
export default function WindPalPrivacy() {
  return (
    <LegalPage title="WindPal Privacy Policy">
      <p><strong>Effective date:</strong> {EFFECTIVE_DATE}</p>
      <p>
        This Privacy Policy describes how TradePals, LLC ("TradePals," "we," "our," or "us") collects, uses,
        and shares information when you use the WindPal mobile app and the WindPal sections of
        tradepals.net (collectively, the "Service"). By using WindPal, you agree to the practices described
        below.
      </p>

      <h2 className="text-xl font-bold text-white mt-6">1. Who we are</h2>
      <p>
        WindPal is operated by <strong>TradePals, LLC</strong>, a Texas limited liability company located
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li><strong>Account information</strong> — email address, password (hashed), display name, and any optional profile fields you provide (such as license type, specialties, primary industry, and experience level).</li>
        <li><strong>Content you submit</strong> — wind turbine panel photos, fault images, equipment photos and other images you upload for AI analysis, troubleshooting forms you fill out, NEC reference lookups, exam prep activity, and any notes you save.</li>
        <li><strong>Usage data</strong> — fault diagnoses, troubleshooting sessions, code lookups, features you use, and timestamps. We use this to provide history, save your work, and enforce subscription limits.</li>
      ...
      <ul className="list-disc pl-6 space-y-1">
        <li>To provide AI-powered wind turbine photo analysis and troubleshooting features.</li>
      ...
      <p>We share information only with service providers that help us operate WindPal:</p>
      <ul className="list-disc pl-6 space-y-1">
        <li><strong>Anthropic (Claude API)</strong> — image and text content you submit for wind turbine analysis is sent to Anthropic solely to generate the AI response. Anthropic processes this content under their own terms; per their published API policy, content sent through the API is not used to train their models.</li>
      ...
      <p>
        WindPal is operated from the United States. By using the Service, you understand that your
      ...
      <p>
        WindPal is not directed to children under 13 (or under 16 in the EEA), and we do not knowingly
      ...
      <p className="mt-6 text-sm text-gray-400 italic">
        WindPal analyzes wind turbine photos and provides reference information only. It is not a substitute for proper testing with calibrated meters, nor for the judgment of a licensed electrician or wind turbine inspector.
      </p>
    </LegalPage>
  )
}
