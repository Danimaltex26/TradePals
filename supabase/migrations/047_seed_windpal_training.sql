...
-- ============================================================
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=1), 'GWO_BST', 'Fall protection systems',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=1), 'GWO_BST', 'Harness inspection',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=1), 'GWO_BST', 'Anchor points',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=1), 'GWO_BST', 'Rescue procedures',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=1), 'GWO_BST', 'Climb assist systems',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=2), 'GWO_BST', 'CPR/AED',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=2), 'GWO_BST', 'Trauma response',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=2), 'GWO_BST', 'Confined space first aid',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=2), 'GWO_BST', 'Heat/cold emergencies',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=2), 'GWO_BST', 'Emergency communication',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=3), 'GWO_BST', 'Fire triangle',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=3), 'GWO_BST', 'Extinguisher types',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=3), 'GWO_BST', 'Turbine fire risks',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=3), 'GWO_BST', 'Evacuation procedures',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=3), 'GWO_BST', 'Suppression systems',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=4), 'GWO_BST', 'Lifting techniques',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=4), 'GWO_BST', 'Ergonomic risk assessment',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=4), 'GWO_BST', 'Tool handling at height',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=4), 'GWO_BST', 'Team lifts',
...
((SELECT id FROM m WHERE cert_level='GWO_BST' AND module_number=4), 'GWO_BST', 'Musculoskeletal injury prevention',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=1), 'GWO_BTT', 'Drivetrain components',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=1), 'GWO_BTT', 'Main bearing',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=1), 'GWO_BTT', 'Gearbox operation',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=1), 'GWO_BTT', 'Yaw system',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=1), 'GWO_BTT', 'Pitch system mechanics',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=2), 'GWO_BTT', 'Generator types',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=2), 'GWO_BTT', 'Power conversion',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=2), 'GWO_BTT', 'Transformer basics',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=2), 'GWO_BTT', 'Cable routing',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=2), 'GWO_BTT', 'Grounding and lightning protection',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=3), 'GWO_BTT', 'Hydraulic principles',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=3), 'GWO_BTT', 'Pitch cylinders',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=3), 'GWO_BTT', 'Brake systems',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=3), 'GWO_BTT', 'Filtration',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=3), 'GWO_BTT', 'Troubleshooting hydraulic circuits',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=4), 'GWO_BTT', 'SCADA overview',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=4), 'GWO_BTT', 'PLC fundamentals',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=4), 'GWO_BTT', 'Sensor types',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=4), 'GWO_BTT', 'Safety chain',
...
((SELECT id FROM m WHERE cert_level='GWO_BTT' AND module_number=4), 'GWO_BTT', 'Condition monitoring',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=1), 'ACP_TECH', 'Startup/shutdown procedures',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=1), 'ACP_TECH', 'Power curve analysis',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=1), 'ACP_TECH', 'Curtailment modes',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=1), 'ACP_TECH', 'Cold weather operations',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=1), 'ACP_TECH', 'Grid code compliance',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=2), 'ACP_TECH', 'PM schedules',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=2), 'ACP_TECH', 'Torque procedures',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=2), 'ACP_TECH', 'Lubrication systems',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=2), 'ACP_TECH', 'Filter replacement',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=2), 'ACP_TECH', 'Bolt tensioning',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=3), 'ACP_TECH', 'Visual inspection methods',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=3), 'ACP_TECH', 'Leading edge erosion',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=3), 'ACP_TECH', 'Lightning damage assessment',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=3), 'ACP_TECH', 'Blade repair techniques',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=3), 'ACP_TECH', 'Drone inspection technology',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=4), 'ACP_TECH', 'Power factor correction',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=4), 'ACP_TECH', 'Reactive power control',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=4), 'ACP_TECH', 'Fault ride-through',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=4), 'ACP_TECH', 'Grid frequency response',
...
((SELECT id FROM m WHERE cert_level='ACP_TECH' AND module_number=4), 'ACP_TECH', 'Substation basics',
