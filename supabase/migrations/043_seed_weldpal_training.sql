...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CW' AND module_number=1), 'CW', 'processes',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CW' AND module_number=2), 'CW', 'joints',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CW' AND module_number=3), 'CW', 'inspection',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CW' AND module_number=4), 'CW', 'safety',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CAWI' AND module_number=1), 'CAWI', 'metallurgy',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CAWI' AND module_number=2), 'CAWI', 'codes',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CAWI' AND module_number=3), 'CAWI', 'symbols',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CAWI' AND module_number=4), 'CAWI', 'documentation',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CWI' AND module_number=1), 'CWI', 'metallurgy',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CWI' AND module_number=2), 'CWI', 'nde',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CWI' AND module_number=3), 'CWI', 'code_application',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CWI' AND module_number=4), 'CWI', 'quality',
...
((SELECT id FROM m WHERE cert_level='CWI' AND module_number=4), 'CWI', 'ethics',
