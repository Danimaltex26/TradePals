...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CET' AND module_number=1), 'CET', 'Traction vs hydraulic elevators',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=1), 'CET', 'Car and counterweight systems',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=1), 'CET', 'Door operator types',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=1), 'CET', 'Hoistway components',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=1), 'CET', 'Elevator classifications',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CET' AND module_number=2), 'CET', 'Motor types',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=2), 'CET', 'Controllers',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=2), 'CET', 'Safety circuits',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=2), 'CET', 'Wiring methods',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=2), 'CET', 'Power supply requirements',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CET' AND module_number=3), 'CET', 'Wire ropes and sheaves',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=3), 'CET', 'Guide rails and shoes',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=3), 'CET', 'Buffers and governors',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=3), 'CET', 'Machine room equipment',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=3), 'CET', 'Compensation systems',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CET' AND module_number=4), 'CET', 'Lockout/tagout',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=4), 'CET', 'Pit safety',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=4), 'CET', 'Top of car operations',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=4), 'CET', 'Hoistway entry',
...
((SELECT id FROM m WHERE cert_level='CET' AND module_number=4), 'CET', 'Emergency evacuation',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=1), 'QEI', 'ASME A17.1/CSA B44',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=1), 'QEI', 'ASME A17.2 inspection guide',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=1), 'QEI', 'Local jurisdiction requirements',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=1), 'QEI', 'Code edition applicability',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=1), 'QEI', 'Variance procedures',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=2), 'QEI', 'Category 1 testing',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=2), 'QEI', 'Category 5 testing',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=2), 'QEI', 'Annual testing requirements',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=2), 'QEI', 'Load testing',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=2), 'QEI', 'Firefighter service testing',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=3), 'QEI', 'Inspection reports',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=3), 'QEI', 'Violation categories',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=3), 'QEI', 'Correction timelines',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=3), 'QEI', 'Record keeping',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=3), 'QEI', 'Witnessing tests',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=4), 'QEI', 'Jack types',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=4), 'QEI', 'Hydraulic fluids',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=4), 'QEI', 'Pressure relief valves',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=4), 'QEI', 'Underground cylinders',
...
((SELECT id FROM m WHERE cert_level='QEI' AND module_number=4), 'QEI', 'Hydraulic machine rooms',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=1), 'CAT', 'ADA elevator requirements',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=1), 'CAT', 'Car size requirements',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=1), 'CAT', 'Door timing',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=1), 'CAT', 'Hall call placement',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=1), 'CAT', 'Reach range requirements',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=2), 'CAT', 'Braille requirements',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=2), 'CAT', 'Tactile buttons',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=2), 'CAT', 'Audible signals',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=2), 'CAT', 'Car position indicators',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=2), 'CAT', 'Emergency communication',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=3), 'CAT', 'Emergency lighting',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=3), 'CAT', 'Emergency communication devices',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=3), 'CAT', 'Battery backup',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=3), 'CAT', 'Two-way communication',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=3), 'CAT', 'ADA emergency requirements',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=4), 'CAT', 'Upgrade planning',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=4), 'CAT', 'Code compliance for modernization',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=4), 'CAT', 'Destination dispatch',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=4), 'CAT', 'Energy efficiency',
...
((SELECT id FROM m WHERE cert_level='CAT' AND module_number=4), 'CAT', 'Machine-room-less elevators',
