...
-- ============================================================
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=1), 'APPRENTICE', 'Pipe materials',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=1), 'APPRENTICE', 'Fitting types',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=1), 'APPRENTICE', 'Joint methods',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=1), 'APPRENTICE', 'Water pressure basics',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=1), 'APPRENTICE', 'Fixture rough-in dimensions',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=2), 'APPRENTICE', 'Drain sizing',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=2), 'APPRENTICE', 'Vent requirements',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=2), 'APPRENTICE', 'Trap design',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=2), 'APPRENTICE', 'Grade and slope',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=2), 'APPRENTICE', 'Fixture units',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=3), 'APPRENTICE', 'Supply pipe sizing',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=3), 'APPRENTICE', 'Pressure regulation',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=3), 'APPRENTICE', 'Hot water systems',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=3), 'APPRENTICE', 'Cross-connection control',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=3), 'APPRENTICE', 'Pipe support spacing',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=4), 'APPRENTICE', 'PPE requirements',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=4), 'APPRENTICE', 'Soldering safety',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=4), 'APPRENTICE', 'Trenching hazards',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=4), 'APPRENTICE', 'Tool identification',
...
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=4), 'APPRENTICE', 'Lockout/tagout',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=1), 'JOURNEYMAN', 'IPC structure',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=1), 'JOURNEYMAN', 'UPC requirements',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=1), 'JOURNEYMAN', 'Permit process',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=1), 'JOURNEYMAN', 'Inspection points',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=1), 'JOURNEYMAN', 'Code calculations',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=2), 'JOURNEYMAN', 'Gas pipe sizing',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=2), 'JOURNEYMAN', 'BTU load calculations',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=2), 'JOURNEYMAN', 'Appliance venting',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=2), 'JOURNEYMAN', 'Leak testing',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=2), 'JOURNEYMAN', 'CSST installation',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=3), 'JOURNEYMAN', 'Cross-connection types',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=3), 'JOURNEYMAN', 'Backflow preventer types',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=3), 'JOURNEYMAN', 'Annual testing',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=3), 'JOURNEYMAN', 'Installation requirements',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=3), 'JOURNEYMAN', 'Hazard assessment',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=4), 'JOURNEYMAN', 'Fixture count calculations',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=4), 'JOURNEYMAN', 'Grease interceptors',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=4), 'JOURNEYMAN', 'Storm drainage',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=4), 'JOURNEYMAN', 'Multi-story risers',
...
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=4), 'JOURNEYMAN', 'Expansion compensation',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=1), 'MASTER', 'WSFU calculations',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=1), 'MASTER', 'Pipe sizing methods',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=1), 'MASTER', 'Pump selection',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=1), 'MASTER', 'Recirculation systems',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=1), 'MASTER', 'Pressure loss calculations',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=2), 'MASTER', 'NFPA 99 requirements',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=2), 'MASTER', 'Oxygen piping',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=2), 'MASTER', 'Vacuum systems',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=2), 'MASTER', 'Brazing procedures',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=2), 'MASTER', 'Alarm systems',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=3), 'MASTER', 'Blueprint reading',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=3), 'MASTER', 'Material takeoffs',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=3), 'MASTER', 'Scheduling',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=3), 'MASTER', 'Labor estimation',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=3), 'MASTER', 'Change order management',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=4), 'MASTER', 'Camera inspection',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=4), 'MASTER', 'Pressure testing',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=4), 'MASTER', 'Leak detection',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=4), 'MASTER', 'System balancing',
...
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=4), 'MASTER', 'Root cause analysis',
