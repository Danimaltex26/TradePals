...
((SELECT id FROM m WHERE cert_level='FOT' AND module_number=1 LIMIT 1),
 'FOT', 'fiber_types',
...
((SELECT id FROM m WHERE cert_level='FOT' AND module_number=2 LIMIT 1),
 'FOT', 'connector_types',
...
((SELECT id FROM m WHERE cert_level='FOT' AND module_number=3 LIMIT 1),
 'FOT', 'power_meters',
...
((SELECT id FROM m WHERE cert_level='FOT' AND module_number=4 LIMIT 1),
 'FOT', 'laser_safety',
...
((SELECT id FROM m WHERE cert_level='CFOT' AND module_number=1 LIMIT 1),
 'CFOT', 'attenuation',
...
((SELECT id FROM m WHERE cert_level='CFOT' AND module_number=2 LIMIT 1),
...
((SELECT id FROM m WHERE cert_level='CFOT' AND module_number=3 LIMIT 1),
 'CFOT', 'trace_reading',
...
((SELECT id FROM m WHERE cert_level='CFOT' AND module_number=4 LIMIT 1),
...
((SELECT id FROM m WHERE cert_level='CFOS_S' AND module_number=1 LIMIT 1),
...
((SELECT id FROM m WHERE cert_level='CFOS_S' AND module_number=2 LIMIT 1),
...
((SELECT id FROM m WHERE cert_level='CFOS_S' AND module_number=3 LIMIT 1),
 'CFOS_S', 'ribbon_fiber',
...
((SELECT id FROM m WHERE cert_level='CFOS_S' AND module_number=4 LIMIT 1),
 'CFOS_S', 'enclosures',
...
((SELECT id FROM m WHERE cert_level='CFOS_T' AND module_number=1 LIMIT 1),
...
((SELECT id FROM m WHERE cert_level='CFOS_T' AND module_number=2 LIMIT 1),
...
((SELECT id FROM m WHERE cert_level='CFOS_T' AND module_number=3 LIMIT 1),
...
((SELECT id FROM m WHERE cert_level='CFOS_T' AND module_number=4 LIMIT 1),
 'CFOS_T', 'test_reports',
