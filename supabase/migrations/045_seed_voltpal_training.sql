...
-- ============================================================
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=1), 'APPRENTICE', 'electrical_theory',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=2), 'APPRENTICE', 'nec_basics',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=3), 'APPRENTICE', 'residential_wiring',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='APPRENTICE' AND module_number=4), 'APPRENTICE', 'electrical_safety',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=1), 'JOURNEYMAN', 'commercial_wiring',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=2), 'JOURNEYMAN', 'motor_controls',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=3), 'JOURNEYMAN', 'grounding_bonding',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='JOURNEYMAN' AND module_number=4), 'JOURNEYMAN', 'transformers',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=1), 'MASTER', 'advanced_load_calculations',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=2), 'MASTER', 'hazardous_locations',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=3), 'MASTER', 'power_quality',
...
-- ============================================================
((SELECT id FROM m WHERE cert_level='MASTER' AND module_number=4), 'MASTER', 'project_management_code',
